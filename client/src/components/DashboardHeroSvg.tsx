export default function DashboardHeroSvg() {
  return (
    <svg width="600" height="400" viewBox="0 0 600 400" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <text x="410" y="263" fontFamily="Arial, sans-serif" fontSize="10" fill="#1a365d">After Stacked Profits (5X Growth)</text>

      {/* 5X Badge */}
      <circle cx="500" cy="250" r="30" fill="url(#greenGradient)"/>
      <text x="485" y="258" fontFamily="Arial, sans-serif" fontWeight="bold" fontSize="20" fill="white">5X</text>
